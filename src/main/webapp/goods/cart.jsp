	...
	$('.pay-btn').click(function(){
		...
		$.ajax({
			...
			data:{"gno":gno,"account":account,"price":price,
				  "post":post,"addr1":addr1,"addr2":addr2,"msg":msg
			},
  ...
  <div>
    ...
    <div class="card">
      ...
      <div class="form-group">
        <label>수취인</label>
        <input type="text" value="${mvo.name }" id="name">
      </div>

      <div class="form-group">
        <label>연락처</label>
        <input type="text" value="${mvo.phone }" id="phone">
      </div>

      <div class="form-group">
        <label>우편번호</label>
        <div class="zip-row">
          <input type="text" value="${mvo.post}" id="post">
      ...
      <div class="form-group">
        <label>주소</label>
        <input type="text" value="${mvo.addr1 }" id="addr1">
      </div>

      <div class="form-group">
        <label>상세주소</label>
        <input type="text" value="${mvo.addr2 }" id="addr2">
      </div>
  ...
  <aside class="summary card">
    ...
    <ul>
      ...
      <li><span id="buys" data-cont="${gvo.goods_name }(수량:${account})"
        data-total="${total }" data-no="${gvo.no }" data-email="${mvo.email }" data-account="${account }" data-price=" ${gvo.goods_price }"
